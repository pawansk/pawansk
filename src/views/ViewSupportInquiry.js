...
const ViewSupportInquiry = ()=>{
    ...
    const modalClose = ()=>{
        setCompletedPortinTable(false);
    };
    const modalHeading = "Inquiry";

    const CompletedPortin = [
        {'Sr No':{value:'1'}, 'Reference Number	':{value:'REF6485920'}, 'MSISDN':{value:''}, 'SIM':{value:'89014103277204958503',},
        'Partner name':{value:'DEMO_TESTMVNO',}, 'Representative name':{value:'test@gmail.com'}, 'Status':{value:'New'}, 
        ...
        actions: [
            { label: 'View', onClick: () => handleClick1(1) }
          ]},
        },
    ...
    return(
        <div>
            <div>
            <CardHeading CardHeadingText ="Support Inquiry"> 
        <div className='row'>
            ...
            <CardHeading CardHeadingText ="View Support Inquiry" cardHeadingText="Download" cardHeadingTextClass="archive_button">
