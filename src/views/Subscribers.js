...
const msisdnTable = [
   { 'Sr No': { value: '1' }, 'ACC Type': { value: 'PORTING', classNamew: 'highlight' }, 
    'Vendor/MVNO': { value: 'PORTING' }, 'MSISDN':{value: '754-876-7676', link: '/TotalRecords',},
    'SIM':{value:'68678685689645474'}, 'IMEI':{value:'544757586785354'}, 'Zip':{value:'55474'},
    'Activation Date':{value:'11-05-2024 23:00:54'},'Account Status':{value:'ACTIVE', tdClass:'table-active'}, 'Action':{value:'REPROCESS',  tdClass: 'tdClass', linkClass:'modal_text_link', onClick: handleCellClick} },

    { 'Sr No': { value: '2', className: 'highlight' }, 'ACC Type': { value: 'PORTING', classNamew: 'highlight' }, 
    'Vendor/MVNO': { value: 'AttLiveTestAbhi' }, 'MSISDN':{value: '867-876-7864', link: '/TotalRecords',},
    ...
    'Vendor/MVNO': { value: 'DEMO_TESTMVNO' }, 'MSISDN':{value: '803-397-1388', link: '/TotalRecords',},
    'SIM':{value:'8686280233121136867'}, 'IMEI':{value:'78685745787697'}, 'Zip':{value:'64643'},
    'Activation Date':{value:'05-09-2024 03:48:51'},'Account Status':{value:'REJECTED', tdClass:'table-rejected'}, 'Action':{value:'REPROCESS',  tdClass: 'tdClass', linkClass:'modal_text_link', onClick: handleCellClick} },

    { 'Sr No': { value: '4', className: 'highlight' }, 'ACC Type': { value: 'PORTING', classNamew: 'highlight' }, 
    'Vendor/MVNO': { value: 'ATTLIVETEST' }, 'MSISDN':{value: '867-876-7864', link: '/TotalRecords',},
    'SIM':{value:'68678685689645474'}, 'IMEI':{value:'757585787785007'}, 'Zip':{value:'86843'},
    'Activation Date':{value:'14-03-2024 22:00:34'},'Account Status':{value:'REJECTED', tdClass:'table-rejected'}, 'Action':{value:'REPROCESS',  tdClass: 'tdClass', linkClass:'modal_text_link', onClick: handleCellClick} },

    { 'Sr No': { value: '5', className: 'highlight' }, 'ACC Type': { value: 'PORTING', classNamew: 'highlight' }, 
    'Vendor/MVNO': { value: 'AttLiveTestAbhi' }, 'MSISDN':{value: '803-397-1388', link: '/TotalRecords',},
    'SIM':{value:'65456757586864567'}, 'IMEI':{value:'64654757658657'}, 'Zip':{value:'45006'},
    'Activation Date':{value:'30-11-2024 24:48:54'},'Account Status':{value:'ACTIVE', tdClass:'table-active'}, 'Action':{value:'REPROCESS',  tdClass: 'tdClass', linkClass:'modal_text_link', onClick: handleCellClick} },

    { 'Sr No': { value: '6', className: 'highlight' }, 'ACC Type': { value: 'ACTIVATION', classNamew: 'highlight' }, 
    'Vendor/MVNO': { value: 'DEMO_TESTMVNO', }, 'MSISDN':{value: '867-876-7864', link: '/TotalRecords',},
    'SIM':{value:'86785858679797657'}, 'IMEI':{value:'756757586785007'}, 'Zip':{value:'45634'},
    'Activation Date':{value:'05-11-2024 15:00:33'},'Account Status':{value:'REJECTED', tdClass:'table-rejected'},  'Action':{value:'REPROCESS',  tdClass: 'tdClass', linkClass:'modal_text_link', onClick: handleCellClick} },
];
