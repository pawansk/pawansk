...
const MSISDNChangeReport = () =>{
const PageHeading ="MSISDN Change Report"
return(
    <div>
    <PageTitle PageHeading={PageHeading}></PageTitle>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div className='text-info'>Total New SIM: 1</div>
                    <div className='text-success'>Total Completed SIM: 0</div>
                    <div className='text-warning'>Total Processing SIM: 3</div>
                    <div className='text-danger'>Total Failed SIM: 0</div>
                    <div className='mt-1'>
                        <button className='btn btn-primary btn-sm me-2'>Send to Carrier</button>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div className='text-success'>Total Completed SIM: 2</div>
...
export default MSISDNChangeReport;