...
const MSISDNDisconnectReport = () =>{
const PageHeading ="MSISDN Disconnect Report"
return(
    <div>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <div className='text-success'>Total Completed SIM: 3</div>
                    <div className='text-warning'>Total Processing SIM: 0</div>
                    <div className='text-danger'>Total Failed SIM: 1</div>
                </td>
            </tr>
            <tr>
                <td>2</td>
...
export default MSISDNDisconnectReport;